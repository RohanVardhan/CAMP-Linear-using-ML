...
for filenum = 8296:1:9123%filenumbers
    FileNumber = filenum
    scenario = scenario + 1;
    ...
    % almost Rate*(1-PER), 
    Rate = 10; 
%     PER = 0.00; directory = 'groundTruth'; % PER = 0
%     PER = 0.10; directory = 'PER_10';
%     PER = 0.20; directory = 'PER_20';
%     PER = 0.30; directory = 'PER_30';
%     PER = 0.40; directory = 'PER_40';
%     PER = 0.50; directory = 'PER_50';
%     PER = 0.60; directory = 'PER_60';
%     PER = 0.70; directory = 'PER_70';
%     PER = 0.80; directory = 'PER_80';
     PER = 0.90; directory = 'PER_90';
   ...
   % directory = 'PER_10';
    ...
    v_data = horzcat(v_lv_rcvd', v_fv', a_lv_rcvd, a_fv', est_Separation_Dist', WarningRangeCalculatedUsingReceivedInfo');
    csvwrite(f,v_data);
    %
